...
class CreateTarjetaamarillaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tarjetaamarilla', function (Blueprint $table) {
            $table->increments('id');

            $table->integer('tamarilla');
            $table->string('minuto');
