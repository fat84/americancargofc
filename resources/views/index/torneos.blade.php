...
@section('contenido')
    ...
    @include('partials.mensajes')
        ...
        <div class="col-sm-10 col-md-10 col-sm-offset-1 col-md-offset-1" style="border: 0px; margin-top: 2%;">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($torneos as $torneo)
                            <tr>
                                ...
                                <td class="text-capitalize">{{ $torneo->inicio }}</td>
                                <td class="text-capitalize">{{ $torneo->fin }}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
