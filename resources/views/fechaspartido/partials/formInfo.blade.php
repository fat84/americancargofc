        ...
        <div class="row">
            ...
            <div class='col-sm-4'>
                <div class="form-group">
                    ...
                    @else
                        @if(isset($escenarios) && is_array($escenarios))
                            {{ Form::select('escenario_id', $escenarios , null, ['placeholder' => 'Seleccione Lugar', 'class' => 'form-control', 'required'=>'required']) }}
                        @endif
                    @endif
                </div>
            </div>
            ...
            <div class='col-sm-4'>
                <div class="form-group">
                    ...
                    @else
                        @if(isset($horas) && is_array($horas))
                            {{ Form::select('hora', $horas , null, ['placeholder' => 'Seleccione Hora', 'class' => 'form-control', 'required'=>'required']) }}
                        @endif
                    @endif
                </div>
            </div>
        ...
        <div class="row">
            <div class='col-sm-6'>
                <div class="form-group">
                    ...
                    @else
                        @if(isset($equipos) && is_array($equipos))
                            {{ Form::select('equipouno', $equipos , null, ['placeholder' => 'Seleccione Equipo', 'class' => 'form-control select2', 'required'=>'required','style'=>'width: 100%;']) }}
                        @endif
                    @endif
                </div>
            </div>
            ...
            <div class='col-sm-6'>
                <div class="form-group">
                    ...
                    @else
                        @if(isset($equipos) && is_array($equipos))
                            {{ Form::select('equipodos', $equipos , null, ['placeholder' => 'Seleccione Equipo', 'class' => 'form-control select2', 'required'=>'required','style'=>'width: 100%;']) }}
                        @endif
                    @endif
                </div>
            </div>
