        ...
        <div class="box-body">
            ...
            <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#tamarillas" aria-controls="tamarillas" role="tab" data-toggle="tab">Tarjetas Rojas</a></li>
                    <li role="presentation"><a href="#historial" aria-controls="historial" role="tab" data-toggle="tab">Historial</a></li>
                </ul>

                <!-- Tab panes -->
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="tamarillas">
                        <br>
                        <div class="table-responsive ">
                            <table class="table table-hover" id="tablatamarillas">
                                ...
                                <tbody>
                                @foreach($tamarillas as $tamarilla)
                                    <tr>
                                        <td class="text-capitalize" >{{ $tamarilla->nombre}} {{ $tamarilla->apellido }}</td>
                                        <td class="text-capitalize" >{{ $tamarilla->nombreequipo }}</td>
                                        <td class="text-capitalize" >{{ $tamarilla->sumtamarilla }}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                                ...
                                @foreach($historial as $histo)
                                    <tr>
                                        ...
                                        <td class="text-cente">
                                            ...
                                            ?>
                                            <div class="btn-group">
                                                <a href="#" onclick="validar('{{url('deletetamarilla'.$histo->id)}}', '¿Esta seguro de eliminar?')" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Eliminar"><i class="fa fa-remove"></i></a>
                                            </div>
                                            <?php
                                            }
                                            } ?>
