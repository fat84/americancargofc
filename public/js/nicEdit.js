...
var nicEditorConfig = bkClass.extend({
	buttons : {
		'bold' : {name : __('Click para negrilal'), command : 'Bold', tags : ['B','STRONG'], css : {'font-weight' : 'bold'}, key : 'b'},
		'italic' : {name : __('Click para cursiva'), command : 'Italic', tags : ['EM','I'], css : {'font-style' : 'italic'}, key : 'i'},
		'underline' : {name : __('Click para subarayado'), command : 'Underline', tags : ['U'], css : {'text-decoration' : 'underline'}, key : 'u'},
		'left' : {name : __('Alienar a la izquierda'), command : 'justifyleft', noActive : true},
		'center' : {name : __('Alinear al centro'), command : 'justifycenter', noActive : true},
		'right' : {name : __('Alinear a la derecha'), command : 'justifyright', noActive : true},
		'justify' : {name : __('Alienar justificado'), command : 'justifyfull', noActive : true},
		...
		'subscript' : {name : __('Click para Subscript'), command : 'subscript', tags : ['SUB']},
		'superscript' : {name : __('Click para Superscript'), command : 'superscript', tags : ['SUP']},
		'strikethrough' : {name : __('Click to Strike Through'), command : 'strikeThrough', css : {'text-decoration' : 'line-through'}},
		'removeformat' : {name : __('Remover el formato'), command : 'removeformat', noActive : true},
		'indent' : {name : __('Indentar texto'), command : 'indent', noActive : true},
		'outdent' : {name : __('Remover Indentación'), command : 'outdent', noActive : true},
		'hr' : {name : __('Linea horizontal'), command : 'insertHorizontalRule', noActive : true}
	},
